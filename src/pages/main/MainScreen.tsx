...
export function MainScreen({ dogs, activeDogIdx, onSwitchDog, onAddDog, weather, onReset, onGoToWalkRecord }: MainScreenProps) {
  ...
  return (
    <div className="app-shell">
      <div className="topnav">
        <button className="icon-btn" onClick={onReset}><Icon name="back" size={22}/></button>
